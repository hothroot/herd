/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0d8a467cad86b0f561d528bf2d79c820)
// Runtime types generated with workerd@1.20250617.0 2025-06-23 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		IS_WRANGLER: true;
		FIVECALLS_API: string;
		GOOGLE_TOKEN: string;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IS_WRANGLER" | "FIVECALLS_API" | "GOOGLE_TOKEN">> {}
}
